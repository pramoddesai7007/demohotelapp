...
const CustomerPayment = () => {
  ...
  useEffect(() => {
    axios
      .get("https://demoback-one.vercel.app/api/customer/customers")
  ...
  useEffect(() => {
    if (selectedCustomer) {
      axios
        .get(`https://demoback-one.vercel.app/api/customer/customers/${selectedCustomer}`)
        .then((response) => {
  ...
  //       `https://demoback-one.vercel.app/api/customer/updateBalance/${selectedCustomer}`,
  //       {
  //         debit: debitAmount,
  //       }
  //     );
  ...
  //       `https://demoback-one.vercel.app/api/customer/customers/${selectedCustomer}`
  //     );
  ...
  //     await axios.delete(
  //       `https://demoback-one.vercel.app/api/customer/customers/${selectedCustomer}/dateWiseRecords/${recordId}`
  //     );
  ...
  const handleDeleteConfirmation = async () => {
    try {
      // Delete the record on the server
      await axios.delete(
        `https://demoback-one.vercel.app/api/customer/customers/${selectedCustomer}/dateWiseRecords/${deleteRecordId}`
      );
