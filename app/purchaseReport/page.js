...
const PurchaseReport = () => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        const purchasesResponse = await axios.get("https://demoback-one.vercel.app/api/purchase/purchases");
        ...
        const vendorsResponse = await axios.get("https://demoback-one.vercel.app/api/supplier/suppliers");
