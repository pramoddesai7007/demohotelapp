...
const Section = () => {
  ...
  useEffect(() => {
    const fetchSections = async () => {
      try {
        const response = await axios.get("https://demoback-one.vercel.app/api/section");
  ...
  const handleEditSubmit = async () => {
    ...
    try {
      ...
      await axios.patch(
        `https://demoback-one.vercel.app/api/section/${sectionToEdit._id}`,
        {
  ...
  const handleDeleteConfirmed = async () => {
    ...
    try {
      await axios.delete(
        `https://demoback-one.vercel.app/api/section/${sectionToDelete._id}`
      );
      ...
      const sectionsResponse = await axios.get(
        "https://demoback-one.vercel.app/api/section"
      );
  ...
  const handleAddSubmit = async () => {
    try {
      ...
      const response = await axios.post(
        "https://demoback-one.vercel.app/api/section/create",
        formData,
        {
          headers: {
