...
const Tables = () => {
    ...
    const handleView = async (tableId) => {
        try {
            const response = await axios.get(`https://demoback-one.vercel.app/api/table/tables/${tableId}`);
    ...
    useEffect(() => {
        const fetchTables = async () => {
            try {
                const tablesResponse = await axios.get('https://demoback-one.vercel.app/api/table/tables');
    ...
    useEffect(() => {
        const fetchtables = async () => {
            try {
                const response = await axios.get('https://demoback-one.vercel.app/api/table/tables');
    ...
    const confirmDelete = async () => {
        try {
            ...
            const response = await axios.delete(
                `https://demoback-one.vercel.app/api/table/tables/${tableToDelete._id}`
            );
